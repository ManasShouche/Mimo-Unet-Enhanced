"""
OPTION 1: Minimal changes to train.py
Just fix the FFT deprecation warning and add pretrained loading support
"""
...
def _train(model, args):
    ...
    # NEW: Load pretrained weights if provided
    if hasattr(args, 'pretrained_path') and args.pretrained_path:
        from models.MIMOUNet import load_pretrained_weights
        print("\n" + "="*60)
        print("LOADING PRETRAINED WEIGHTS")
        print("="*60)
        model = load_pretrained_weights(model, args.pretrained_path, strict=False)
        print("="*60 + "\n")
    ...
    for epoch_idx in range(epoch, args.num_epoch + 1):
        ...
        for iter_idx, batch_data in enumerate(dataloader):
            ...
            # MODIFIED: Fix deprecated torch.rfft
            try:
                # Use new torch.fft API (PyTorch >= 1.7)
                ...
                # Loss on real and imaginary parts
                ...
                try:
                    ...
                    # If FFT fails completely, skip FFT loss
    ...
    print(f'\n✓ Training complete! Final model saved to {save_name}')


# ============================================================================
# WHAT CHANGED IN THIS FILE:
# ============================================================================
# 1. Added pretrained weight loading at the start of _train() (lines 17-24)
# 2. Fixed FFT deprecation with try-except fallback (lines 59-90)
# 3. Added better logging messages (lines 132, 137)
# ============================================================================